...
# The reason it was returning 0.0 in some of the results was a result of the idf
# dividing an integer value by an integer value. This would also result in 0 which 
# would be the number returned to the tfidf. By making the number_of_documents and 
# the number_of_documents_with_term floating point values, The division would return
# a float object which could then be used in the main equation in tfidf:
